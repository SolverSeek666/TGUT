...
// =================================================
function UPneg7() {
  if (game.numbers >= 0.000000001) {
    if (game.upNeg7Count >= 2-1) {
      game.upNeg7Count += 1
      game.numbers *= 3
      document.getElementById("number").innerHTML = formatNum(game.numbers);
      document.getElementById("upneg7-buy-count").innerHTML = "Buy: " + game.upNeg7Count + "/2";
      document.getElementById("upneg7-cost").innerHTML = "Upgrade Maxed";
...
// =================================================
function UPneg6() {
  if (game.numbers >= 0.000000009) {
    game.upNeg6Count += 1
    game.numbers += 0.000000001
    document.getElementById("number").innerHTML = formatNum(game.numbers);
    document.getElementById("upneg6-buy-count").innerHTML = "Buy: " + game.upNeg6Count + "/1";
    document.getElementById("upneg6-cost").innerHTML = "Upgrade Maxed";
    document.getElementById("upgrade-neg6").disabled = true;
    return;
  }
}
